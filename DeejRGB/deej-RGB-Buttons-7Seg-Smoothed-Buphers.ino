...
const int analogInputs[NUM_SLIDERS] = {A10, A0, A1, A2, A3}; //Analog Input pin designation
...
const int digitalInputs[NUM_BUTTONS] = {2,3,4,5,6}; //Digital Input Designation
